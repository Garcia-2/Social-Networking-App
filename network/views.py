...
def edit(request, post_id):
    if request.method == "POST":
        ...
        try:
            ...
            return JsonResponse({"message": "Error Unable to save changes"})
...
def remove_like(request, post_id):
    ...
    like.delete()
    print(f"Like removed for post {post_id}")
...
def add_like(request, post_id):
    ...
    newLike.save()
    print(f"Like added for post {post_id}")
